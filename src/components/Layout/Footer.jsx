  ...
  return (
    <footer>
        ...
        <div className={classes.box}>
          ...
          <div className={classes.list}>
            <p>
              ...
              Cairo, or call us on (+20) 0109 774 1471
            </p>
          </div>
          <div className={classes.links}>
            <Link
              to={"https://github.com/Mo5444237"}
              target="_blank"
            ...
            <Link
              to={"https://www.linkedin.com/in/mohamed-ibrahim-292798294"}
              target="_blank"
      ...
      <div className={classes.end}>
        ...
        <Link target="_blank" to={"https://github.com/Mo5444237"}>Mohammed ibrahim</Link>
      </div>
    </footer>
  );
};
